...
def customer_status_disabled():
	cust = frappe.get_list("Customer", filters={"email_id": frappe.session.user}, fields=["name", "disabled"])
	if cust:
...
def send_signal_notifications(message, recipients):
	if recipients != "[]":
		...
		# raise frappe.PermissionError(recipients, "RECIPIENT")
		# frappe.error_log(recipients, "Recipients List")
...
def send_fcm_notifications(message, data, email_list):
	...
	# frappe.error_log(tokens, "Tokens")
...
# /home/frappe/frappe-bench/apps/customer_portal_cv/customer_portal_cv/customer_portal_capitalvia/cp_facilitator.py
# /home/frappe/frappe-bench/apps/customer_portal_cv/customer_portal_cv/customer_portal_capitalvia/cv_utilities.py
# /home/frappe/frappe-bench/apps/customer_portal_cv/customer_portal_cv/customer_portal_capitalvia/fcm_utils.py
# /home/frappe/frappe-bench/apps/customer_portal_cv/customer_portal_cv/customer_portal_capitalvia/portal_user_utilities.py
# /home/frappe/frappe-bench/apps/customer_portal_cv/customer_portal_cv/customer_portal_capitalvia/upi_payment.py